// 1 - Um array esparso é um tipo de array no qual a maioria dos elementos tem valores indefinidos. Crie um array esparso e atribua valores a alguns elementos do array 
...
const meuArray1 = []; // Criando um array vazio
meuArray1.push(5); // Adicionando números ao array
meuArray1.push(10);
meuArray1.push(15);

//Exibição dos Itens
console.log("Itens no array meuArray1:", meuArray1);
...
//meuArray[0] *= 2;
console.log("Array após a atualização do primeiro elemento:", meuArray1);
...
console.log("Array resultante do meu array2: ", meuArray2);
...
// Removendo cada animal da lista após atendimento:
clinica.pop();
clinica.pop();
clinica.pop();

// Exibindo o estado final da lista:
console.log("Fila de animais aguardando após atendimento: ", clinica);